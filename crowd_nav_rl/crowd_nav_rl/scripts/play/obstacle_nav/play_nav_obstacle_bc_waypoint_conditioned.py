...
parser = argparse.ArgumentParser(description="Play waypoint-conditioned obstacle BC policy.")
AppLauncher.add_app_launcher_args(parser)

parser.add_argument("--checkpoint", type=str, default="logs/fwmini_obstacle_bc_wp/latest.pt")
...
def main():
    ...
    print("[INFO] Start waypoint-conditioned obstacle BC play")
